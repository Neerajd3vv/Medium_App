  ...
  return (
    <>
      <div className="flex justify-center mb-2">
        <div className="py-12 px-8 border-b-2 shadow-lg grid grid-cols-3  border-slate-300 max-w-5xl w-full rounded-md">
          <div className="grid  col-span-2">
            ...
            <div className="text-lg max-w-2xl text-slate-700 mb-8 font-ptserif">
              ...
              <div
                onClick={readBlog}
                className="text-Myblue underline cursor-pointer font-Afacad"
              >
                Read more...
              </div>
            </div>
...
function AvatarProfile({ userImage }: { userImage?: any }) {
  return (
    <img className="w-10 h-10  rounded-full" src={userImage} alt="image" />
  );
}
